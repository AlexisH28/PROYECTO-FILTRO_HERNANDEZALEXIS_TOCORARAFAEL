...
function mostrarProductos(productos) {
    const contenedor = document.getElementById('productos-container-2');
    if (contenedor) {
        ...
        console.error('Elemento "productos-container-2" no encontrado en el DOM. Asegúrate de que existe en tu HTML.');
    }
}
